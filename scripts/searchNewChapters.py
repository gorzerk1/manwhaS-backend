    ...
    for chapter in chapter_nums:
        ...
        try:
            ...
            if target_div:
                ...
                print(f"❌ Expected outer div not found on chapter {chapter} page")
        except Exception as e:
            print(f"❌ Error checking chapter {chapter}: {e}")
